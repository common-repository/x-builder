...
<div class="x_categories_carousel_2 <?php echo esc_attr(implode(' ', $classes)); ?>"
     data-module="<?php echo esc_attr($module_id); ?>">
    <h3 class="title"><?php echo wp_kses_post($title); ?></h3>
    <div class="x_categories_carousel_2__items owl-carousel" data-v-if="categories.length">

        <div class="x_categories_carousel_2__item" data-v-for="category in categories">
            <div class="x_categories_carousel_2__item_image">
            ...
            <div class="x_categories_carousel_2__item_content">
                <div class="x_categories_carousel_2__item_title" data-v-html="category.title"></div>
                <div class="x_categories_carousel_2__item_description heading_font" data-v-html="category.description"></div>
                <a data-v-bind_href="category.permalink" class="btn btn-primary"><?php _e('View deals','STM_X_Builder_Front'); ?></a>
            </div>
        </div>
