      ...
      new Vue({
        ...
        data: function data() {
          return {
            ...
            sale: window[module_id]['sale'],
            style: window[module_id]['style'],
            active_category: '',
            products: {},
            loading: false,
            hover: false
        ...
        methods: {
          getProducts: function getProducts(category, _transient) {
            var _this = this;
            ...
            var url = "".concat(x_ajax_url, "?action=x_get_products&term_id=").concat(category.term_id, "&total=").concat(this.total, "&module_id=").concat(module_id, "&sale=").concat(this.sale, "&style=").concat(this.style);
